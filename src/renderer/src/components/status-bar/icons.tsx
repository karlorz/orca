...
export function GrokIcon({ size = 14 }: { size?: number }): React.JSX.Element {
  // Why: grok.com's current orbit-slash mark, not the xAI X. currentColor so
  // the glyph is dark on light chrome and light on dark chrome, like Codex.
  return (
    <svg
      fill="currentColor"
      fillRule="evenodd"
